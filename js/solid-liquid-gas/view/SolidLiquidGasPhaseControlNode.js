...
define( function( require ) {
  ...
  var createGasIcon = function() {
    ...
    var circle1 = new Circle( largeCircleRadius, { stroke: '#3DACFF', fill: new RadialGradient( 0, 0, 0, 0, 0, 15 )
      .addColorStop( 0, '#6BBFF5' )
      .addColorStop( 1, '#3DACFF' )} );
    var circle2 = new Circle( largeCircleRadius, { stroke: '#3DACFF', fill: new RadialGradient( 0, 0, 0, 0, 0, 15 )
      .addColorStop( 0, '#6BBFF5' )
      .addColorStop( 1, '#3DACFF' )} );
    var circle3 = new Circle( 10, { stroke: '#3DACFF', fill: new RadialGradient( 0, 0, 0, 0, 0, 10 )
      .addColorStop( 0, '#6BBFF5' )
      .addColorStop( 1, '#3DACFF' )} );
    var circle4 = new Circle( mediumCircleRadius, { stroke: '#3DACFF',
      fill: new RadialGradient( 0, 0, 0, 0, 0, mediumCircleRadius )
        .addColorStop( 0, '#6BBFF5' )
        .addColorStop( 1, '#3DACFF' )} );
    var circle5 = new Circle( 8, { stroke: '#3DACFF', fill: new RadialGradient( 0, 0, 0, 0, 0, 8 )
      .addColorStop( 0, '#6BBFF5' )
      .addColorStop( 1, '#3DACFF' )} );
    ...
    return new Node( { children: [ circle1, circle2, circle3, circle4, circle5, circle6, circle7,
