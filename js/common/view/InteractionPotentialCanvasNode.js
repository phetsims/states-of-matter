...
define( function( require ) {
  ...
  return inherit( CanvasNode, InteractionCanvasNode, {
    ...
    paintCanvas: function( wrapper ) {
      ...
      for ( var i = 1; i < this.interactionDiagram.graphWidth; i++ ) {
        ...
        if ( (yPos > 0) && (yPos < this.interactionDiagram.graphHeight) ) {
          ...
          if ( yPos > this.interactionDiagram.graphHeight ) {
            context.lineTo( i + this.interactionDiagram.graphXOrigin, this.interactionDiagram.graphHeight + AXES_ARROW_HEAD_HEIGHT );
            if ( (potential > 0) || ( this.interactionDiagram.zeroCrossingPoint.x === 0) ) {
              // zero crossing point.
              this.interactionDiagram.zeroCrossingPoint.setXY( i, this.interactionDiagram.graphHeight / 2 );
            }
      ...
      this.interactionDiagram.epsilonLabel.setTranslation( this.interactionDiagram.graphMin.x + this.interactionDiagram.epsilonLabel.width,
