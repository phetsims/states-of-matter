...
class CompositeThermometerNode extends Node {
  ...
  public constructor( multipleParticleModel: MultipleParticleModel, providedOptions?: CompositeThermometerNodeOptions ) {
    ...
    const temperatureComboBox = new ComboBoxDisplay( this.temperatureUnitsProperty, comboBoxDisplayItems, comboBoxListParent, {
      xMargin: 6,
      yMargin: 4,
      cornerRadius: 5,
      buttonLineWidth: 0.4,
    ...
    this.addLinkedElement( multipleParticleModel.temperatureInKelvinProperty, {
      tandemName: 'temperatureInKelvinProperty'
    } );
  }
